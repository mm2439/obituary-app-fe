  ...
  return (
    <div className="bg-[#F9EBD4] min-h-[100vh] text-[#3C3E41]">
      ...
      <div className="flex flex-col items-center pt-[200px] w-full px-4 max-w-[720px] mx-auto">
        ...
        <section className="mt-10 text-[16px] space-y-6 leading-[1.6] mobile:w-[360px] w-[706px]">
          <div>
          ...
          <div>
            <h3 className="font-medium mb-1 ">Kakšne ‘digitalne produkte za naše stranke’?</h3>
            <p className = "font-light text-[16px]">
          ...
          <div>
            <h3 className="font-medium mb-1 ">Kaj, če se ne vključim ali zamudim?</h3>
            <p className = "font-light text-[16px]">
          ...
          <div>
            <h3 className="font-medium mb-1 ">Kakšna bo cena kasneje?</h3>
            <p className = "font-light text-[16px]">
