...
export default function OpenableBlock({ isDefaultOpen = false, children, title, index, hasDeleteButton = false, havingSpacing = false, helpText = "", openBlock, handleOpenBlock }) {
  ...
  return (
    <div className={`${isOpen ? "pb-[8px]" : "" } ${havingSpacing && isOpen ? "mb-[28px]" : ""}`}>
