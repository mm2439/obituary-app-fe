    ...
    <>
      ...
      <div className="min-h-full flex flex-col justify-between gap-[16px] relative">
        <div className="space-y-[43px]">
          ...
          <div className="space-y-[8px]">
            <OpenableBlock isDefaultOpen={openedBlock === 1} title="Zgornja vrstica" index={1} havingSpacing={true} openBlock={openedBlock === 1} handleOpenBlock={() => setOpenedBlock(1)}>
              ...
              <div className="space-y-[8px]">
                <div className="flex items-center gap-[8px]">
                  <Image src="/phone_icon.png" alt="Spletna stran" width={24} height={24} />
            ...
            <OpenableBlock isDefaultOpen={openedBlock === 2} title="Velika zgornja slika" index={2} openBlock={openedBlock === 2} handleOpenBlock={() => setOpenedBlock(2)}>
              <div className="space-y-[8px]">
                <span className="text-[14px] text-[#3C3E41] font-normal leading-[24px]">Začasno lahko izbereš eno od teh slik in svojo prilepiš naknadno.</span>
              </div>
              <BackgroundSelector />
              <div className="space-y-[8px]">
                <span className="text-[16px] text-[#3C3E41] font-normal leading-[24px]">Ime cvetličarne oz podjetja in kraj</span>
              ...
              <div className="flex items-center gap-[12px]">
                <span className="text-[16px] leading-[24px] text-[#ACAAAA]">Steklen okvirček</span>
                <Image src="/question_mark.png" width={24} height={24} alt="Spletna stran" />
              </div>
              <div className="flex items-center justify-between gap-[12px] py-[2px]">
                <span className="text-[16px] text-[#3C3E41] font-normal leading-[24px]">Prikaži steklen okvir</span>
                <Switch />
                <span className="text-[16px] text-[#3C3E41] font-normal leading-[24px]">Izbriši steklen okvir</span>
              </div>
              <div className="space-y-[8px]">
                <span className="text-[16px] text-[#3C3E41] font-normal leading-[24px]">
                  Naslov v okvirčku
        ...
        <div className="space-y-[48px]">
          {openedBlock === 1 && <div className="space-y-[8px]">
            <p className="text-[14px] leading-[20px] text-[#6D778E]">
            Tako enostavno je!  
            </p>
            <p className="text-[14px] leading-[20px] text-[#6D778E]">
              Nadaljujete postopek po korakih in vmes občasno tudi shranjujte in na zadnjem koraku pritisnite gumb OBJAVI. 
            </p>
            <p className="text-[14px] leading-[20px] text-[#6D778E]">
