        ...
        <div className="space-y-[43px]">
          ...
          <div className="space-y-[8px]">
            <div className="space-y-[8px] pb-[28px]">
              ...
              <input type="text" className="w-full border border-[#6D778E] bg-[#FFFFFF] outline-none rounded-[8px] py-[12px] px-[20px] text-[16px] text-[#3C3E41] placeholder:text-[#ACAAAA] leading-[24px]" placeholder="Žalni program" />
            </div>
            {sliderBlocks.map((block) => (
              <SliderBlock key={block.id} index={block.id} title={`Okvirček ${block.id}`} />
            ))}
    ...
    <OpenableBlock isDefaultOpen={isDefaultOpen} title={title} index={index}>
      <div className="space-y-[16px]">
        ...
        <div className="space-y-[8px]">
          ...
          <input type="text" className="w-full border border-[#6D778E] bg-[#FFFFFF] outline-none rounded-[8px] py-[12px] px-[20px] text-[16px] text-[#3C3E41] placeholder:text-[#ACAAAA] leading-[24px]" placeholder="Čudoviti aranžma št. 1" />
        </div>
        <div className="space-y-[8px]">
          <label className="text-[16px] text-[#3C3E41] font-normal leading-[24px]">
            Cena <span className="text-[#ACAAAA] text-[14px]">(v kolikor jo želite dodati; lahko pustite prazno)</span>
          </label>
          <input type="text" className="w-full border border-[#6D778E] bg-[#FFFFFF] outline-none rounded-[8px] py-[12px] px-[20px] text-[16px] text-[#3C3E41] placeholder:text-[#ACAAAA] leading-[24px]"/>
        </div>
      </div>
    </OpenableBlock>
  )
