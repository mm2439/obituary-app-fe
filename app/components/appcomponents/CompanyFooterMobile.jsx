...
function CompanyFooterMobile({ handleGoToTop, setIsMobilSideBarOpen }) {
    ...
    <div className=" hidden mobileUserAcc:flex tabletUserAcc:flex self-end bottom-0 rounded-t-[12px] fixed z-[999] w-full h-[85px] bg-[#FFFFFF] shadow-lg justify-center items-center">
      ...
      >
        ...
        <div className="flex mobileUserAcc:w-full justify-between tabletUserAcc:gap-[60px]">
          ...
          >
            <IconView iconPath={"/obvestila_icon.png"} name={"Obvestila"} />
          </div>
          ...
          <Link href={"/spominske"}>
            <div>
              <IconView iconPath={"/spominske.png"} name={"Spominske"} />
            </div>
          </Link>
          ...
          {isIconChange ? (
            ...
            <Link href={"/mobi-predloge"}>
              <div>
                <IconView
                  iconPath={"/mobi_predloge.png"}
                  name={"Mobi predloge"}
                />
              </div>
            </Link>
