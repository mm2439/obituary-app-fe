        ...
        <div className="relative flex flex-row min-w-full dekstop:h-[300px] tablet:h-[230px] mobile:h-[236px]">
          ...
          <div
            className="
                            ...
                            tablet:justify-start tablet:pl-11 tablet:items-center desktop:items-center desktop:justify-center desktop:bg-[#FFE5B4]                             
            ...
            >
              <div
                className="flex flex-col items-center justify-between
                                h-full w-full
                                mobile:w-[330px] mobile:h-[110px]
                                desktop:w-[476px] desktop:h-[124px]
                                tablet:h-[167px] tablet:w-[391px] tablet:py-[22px] mobile:py-[22px]
                                tablet:rounded-2xl mobile:border-2 tablet:border-2
                                tablet:border-[#FFFFFF] mobile:border-[#FFFFFF] tablet:shadow-custom-light-dark-banner mobile:shadow-custom-light-dark-banner tablet:bg-gradient-to-r mobile:bg-gradient-to-r tablet:from-[#FFFFFF] mobile:from-[#FFFFFF] tablet:to-[#FFFFFF50] mobile:to-[#FFFFFF50] tablet:backdrop-blur-sm mobile:backdrop-blur-sm
                                "
              >
