    ...
    <div 
      ...
      <div className="relative mt-[100px] tablet:mt-[32px] mb-[76px] tablet:mb-[34px] tablet:w-[629px] mobile:mt-[40px]"> 
        <div className="w-[1076px] mobile:w-full mobile:grid-cols-2 mobile:gap-[22px] mobile:px-[19px] mx-auto grid grid-cols-6 items-end relative z-10">
          <div className="bg-[#36556C] mobile:shadow-lg h-[229px] mobile:h-[129px] mobile:w-[150px] w-full rounded-[4px] overflow-hidden relative" 
          style={{
          ...
          >
            ...
            <div className="bg-[#FF984E] absolute top-[calc(100%-15px)] mobile:top-[calc(100%-8px)] left-[119px] mobile:left-[113px] w-[36px] mobile:w-[19px] h-[30px] mobile:h-[16px] rounded-full">
            </div>
          ...
          <div className="bg-[#FFFFFF] mobile:shadow-lg mobile:!border-[1px] mobile:!border-[#36556C99] mobile:w-[150px] h-[160px] mobile:h-[129px] w-full overflow-hidden relative flex mobile:flex-col items-center justify-center" 
          style={{
            border: "1px solid #36556C1A"
          }}
          >
            <img src="/memory_logo_1.png" alt="cvetlica" className="w-[120px] h-[120px] mobile:w-[97px] mobile:h-[97px]" />
          ...
          >
            <img src="/memory_logo_2.png" alt="cvetlica" className="w-[120px] h-[120px] mobile:w-[97px] mobile:h-[97px]" />
            <div className="bg-[#36556C] text-white text-[12px] hidden mobile:flex w-full h-[30px] items-center justify-center leading-[130%] font-normal text-center">
            Izola
            </div>
          </div>
          <div className="bg-[#FFFFFF] mobile:shadow-lg mobile:w-[150px] h-[160px] mobile:h-[129px] w-full overflow-hidden flex items-center justify-center relative" 
          style={{
            borderTop: "1px solid #36556C1A",
            borderBottom: "1px solid #36556C1A",
            borderRight: "1px solid #36556C1A"
          }}
          >
            <img src="/memory_logo_3.png" alt="cvetlica" className="w-[110px] h-[110px]" />
            <div className="bg-[#36556C] w-full h-full absolute top-0 left-0 text-white text-[12px] hidden mobile:flex items-center justify-center text-center flex-col">
              <span className="text-[#DADADA] text-[16px] leading-[130%] font-normal mt-[16px]">Cvetličarna <br/>
              Erija</span>
              <span className="text-[#DADADA] text-[16px] leading-[130%] font-normal mt-[20px]">Ig</span>
            </div>
              
          </div>
          <div className="bg-[#ffffff] mobile:shadow-lg mobile:w-[150px] h-[229px] mobile:h-[129px] w-full overflow-hidden relative mobile:hidden"
          style={{
            borderTop: "1px solid #36556C1A",
            borderBottom: "1px solid #36556C1A",
            borderRight: "1px solid #36556C1A"
          ...
          >
            <div className="bg-[#36556C] absolute top-[156px] left-[143px] w-[18px] h-[18px] rounded-full">
            </div>
            <img src="/memory_logo_4.png" alt="cvetlica" className="w-[120px] h-[120px] mx-auto mt-[18px]" />
            
            <div className="text-[#36556C80] text-[14px] leading-[130%] font-normal text-center mb-[10px]">
            Nova Gorica
            </div>
          ...
          >
            <img src="/memory_logo_4.png" alt="cvetlica" className="w-[120px] h-[120px] mobile:w-[97px] mobile:h-[97px]" />
            <div className="bg-[#36556C] text-white text-[12px] hidden mobile:flex w-full h-[30px] items-center justify-center leading-[130%] font-normal text-center">
            Nova Gorica
            </div>
          </div>
      ...
      <div className="w-[320px] h-[125px] hidden mobile:block bg-[#36556C] relative mb-[40px] overflow-hidden">
        <p className="font-semibold text-[20px] text-[#E9EAF5] text-center mt-[14px]">Cvetličarna Kalimero</p>
        ...
        <div className="bg-[#FF984E] absolute bottom-[calc(100%-8px)] left-[282px] w-[19px] h-[16px] rounded-full z-10">
        </div>
        <div className="bg-gradient-to-r from-[#FF984E] to-[#36556C] absolute top-0 left-0 w-full h-[3px]"></div>
        <div className="bg-gradient-to-b from-[#FF984E] to-[#36556C] absolute top-0 left-0 w-[3px] h-full"></div>
      </div>
