...
const FuneralCompanies = () => {
  return (
    <div className="w-full bg-[#E0E9F3]">
      <div className='relative  max-w-[1920px]  h-[570px] tablet:h-[597px] mobile:h-[545px] w-full overflow-hidden flex mx-auto justify-center items-center'>

        {/*Main Container for desktop*/}
        <div className=' h-[302px] hidden desktop:flex'>

          {/*header container*/}
          <div className='flex  flex-col'>
            <h1 className='text-[40px] text-[#3C3E41] font-variation-customOpt40 mt-[56px] '>Celovite rešitve za pogrebna podjetja</h1>
