    ...
    return (
        <header className="fixed top-0 left-0 right-0 bg-white shadow-md z-50 ">
          <div className=" flex w-full justify-center">
            <div
              className = {`flex w-full ${isfrom === "ObituaryForm" ? "tablet:h-[92px]" : " tablet:h-[80px]"} h-[72px] px-[10.6px] tablet:w-full ObituaryForm tablet:px-4 desktop:w-[1200px] desktop:h-[92.02px] desktop:px-[18px] justify-between items-center`}>
            ...
            <div  onClick={() => router.back()} className="flex flex-col items-center cursor-pointer ">

              {/* 20 September 2024 height and width for image was asking and implemented check from useraccount with isfrom */}
                <Image
                  src={isfrom === "useraccount"? "/icon_menu_black.png" : back_icon}
                  className="
