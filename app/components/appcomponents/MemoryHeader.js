    ...
    <header className="flex flex-col fixed left-0 right-0 shadow-md z-50 bg-[#FFFFFF]">
      <div className=" flex w-full justify-center">
        <div
          ...
          `}
        >
          <Link href={"/"} className="flex justify-start items-center h-full mobile:hidden">
            <Image
              src={omr}
              alt="App Logo"
              width={500}
          ...
          <div className="flex items-center mobile:flex-row-reverse mobile:justify-between mobile:w-full gap-[70px] tablet:gap-[50px]">
            ...
            <div className="flex tablet:flex-col mobile:flex-col items-center gap-[20px] tablet:gap-[5px] mobile:gap-[5px]">
              ...
              <span className="text-[#3C3E41] text-[20px] tablet:text-[14px] mobile:text-[14px] font-bold">NAZAJ</span>
            </div>
          </div>
