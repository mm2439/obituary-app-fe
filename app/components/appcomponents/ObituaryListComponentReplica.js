...
const CarouselCalendar = () => {
  ...
  const cardSizes = {
    ...
    tablet: {
      selected: { w: 110, h: 160 },
      normal: { w: 75, h: 110 },
      gap: "gap-[0px]",
      maxH: 160,
    },
    desktop: {
      selected: { w: 138, h: 208 },
      normal: { w: 91, h: 138 },
      gap: "gap-[0px]",
      maxH: 208,
    },
  ...
  return (
    <>
      <div
        className={`w-full flex flex-col items-center bg-white border-b-[1px] border-[#C7C7C7] ${
      ...
      >
        ...
        <div className="w-full max-w-fit sm:px-6 py-5 mb-0 flex flex-col items-center ">
          <div className="w-full flex items-center justify-between">
            ...
            {/* 5-Day Carousel */}
            <div
              className={`flex-1 min-w-0 flex justify-center items-end ${cardSizes[screen].gap} px-0 mobile:px-4`}
            >
              {carouselDays.map((day, idx) => {
                ...
                const cardW =
                  selected || today
                    ? cardSizes[screen].selected.w
                    : cardSizes[screen].normal.w;
                const cardH =
                  selected || today
                    ? cardSizes[screen].selected.h
                    : cardSizes[screen].normal.h;
                const maxCardH = cardSizes[screen].maxH;
                return (
                  <div
                    key={idx}
                    className={`flex flex-col items-center ${
                      screen === "mobile" ? "justify-start" : "justify-center"
                    } relative h-fit`}
                  ...
                  >
                    <button
                      ...
                      className={`transition flex flex-col items-center relative focus:outline-none select-none ${
                        selected || today ? "z-10" : "opacity-90"
                      }`}
                      style={{
                        width: cardW,
                        height: cardH,
                        ...
                        cursor:
                          screen === "mobile" && idx > 0
                            ? "default"
                            : "pointer", // Cursor style based on selectability
                      }}
                    >
                      {selected || today ? (
                        <div className="relative w-full h-full flex items-center justify-center">
                          ...
                          >
                            <g filter="url(#filter0_d_7022_1466)">
                              <path
                                d="M28.3125 51.4141V185.116C28.3125 198.613 39.2534 209.554 52.75 209.554H142.353C155.85 209.554 166.791 198.613 166.791 185.116V51.4141C146.021 55.3253 122.487 57.5314 97.5517 57.5314C72.6167 57.5314 49.0823 55.3248 28.3125 51.4141Z"
                                fill="url(#paint0_linear_7022_1466)"
                              />
                            </g>
                            <path
                              d="M142.353 0.914062H52.75C39.2534 0.914062 28.3125 11.8554 28.3125 25.3516V51.4178C49.0823 55.329 72.6167 57.5352 97.5517 57.5352C122.487 57.5352 146.022 55.3286 166.791 51.4178V25.3516C166.791 11.855 155.85 0.914062 142.353 0.914062Z"
                              fill="url(#paint1_linear_7022_1466)"
                            />
                            <text
                              x="50%"
                              y="35"
                            ...
                            <defs>
                              ...
                              >
                                ...
                                <feBlend
                                  ...
                                  result="effect1_dropShadow_7022_1466"
                                />
                                <feBlend
                                  mode="normal"
                                  in="SourceGraphic"
                                  in2="effect1_dropShadow_7022_1466"
                                  result="shape"
                                />
                              </filter>
                              <linearGradient
                                id="paint0_linear_7022_1466"
                                x1="28.3125"
                                y1="130.484"
                                x2="166.791"
                                y2="130.484"
                        ...
                        <div className="relative w-full h-full flex items-center justify-center">
                          ...
                          >
                            <g filter="url(#filter0_d_7017_1465)">
                              <path
                                d="M96.6106 0.65625H38.454C29.3813 0.65625 22 8.03746 22 17.1103V33.3126V34.5195V120.805C22 129.878 29.3813 137.259 38.454 137.259H96.6103C105.683 137.259 113.064 129.877 113.064 120.805V34.5195V33.3126V17.1103C113.065 8.03746 105.683 0.65625 96.6106 0.65625Z"
                                fill="url(#paint0_linear_7017_1465)"
                              />
                              <path
                                d="M22.5898 34.0234V120.8C22.5898 129.56 29.691 136.661 38.4508 136.661H96.6071C105.367 136.661 112.468 129.56 112.468 120.8V34.0234C98.9876 36.5619 83.7128 37.9938 67.5289 37.9938C51.3451 37.9938 36.0703 36.5616 22.5898 34.0234Z"
                                fill="url(#paint1_linear_7017_1465)"
                              />
                              <path
                                d="M96.6071 1.25H38.4508C29.691 1.25 22.5898 8.3513 22.5898 17.1107V34.0285C36.0703 36.567 51.3451 37.9989 67.5289 37.9989C83.7128 37.9989 98.9879 36.5667 112.468 34.0285V17.1107C112.468 8.351 105.367 1.25 96.6071 1.25Z"
                                fill="url(#paint2_linear_7017_1465)"
                                fillOpacity="0.7"
                              />
                            </g>
                            <defs>
                              <filter
                                id="filter0_d_7017_1465"
                                x="0"
                                y="0.65625"
                                width="135.062"
                                height="180.602"
                              ...
                              >
                                ...
                                <feBlend
                                  mode="normal"
                                  in2="BackgroundImageFix"
                                  result="effect1_dropShadow_7017_1465"
                                />
                                <feBlend
                                  mode="normal"
                                  in="SourceGraphic"
                                  in2="effect1_dropShadow_7017_1465"
                                  result="shape"
                                />
                              </filter>
                              <linearGradient
                                id="paint0_linear_7017_1465"
                                x1="22"
                                y1="68.9574"
                                x2="113.065"
                                y2="68.9574"
        ...
        <div className=" flex flex-col items-center w-full tablet:w-full mobile:w-full">
          ...
          <div className="w-full tablet:w-full mobile:w-full flex flex-col items-center">
            ...
            flex tablet:flex-wrap flex-row gap-4 mt-[69.07px] tablet:mt-[40px] mobile:mt-[40px] mobile:mb-[42px] tablet:mb-[53px] mb-[23.93px]"
            >
        ...
        <div className="table-container mx-8 mt-[80px]">
          <table
            className={`${
              screen === "mobile"
                ? "w-full"
              ...
              screen === "mobile" ? "" : "border-t border-gray-300"
            }`}
          >
            <tbody>
              <tr
              ...
              >
                <td
                  className={`text-right pr-4 font-roboto text-[24px] font-normal leading-[28px]  w-[10%]  ${
                    screen === "mobile"
                      ? "align-top text-[#0A85C2]"
                      : "text-[#3C3E41]"
                  }`}
                >
                  9:00
                ...
                <td
                  className={`font-roboto pl-4 text-[18px] font-semibold leading-[21px] text-[#3C3E41] ${
                    screen === "mobile" ? "align-top  w-[90%]" : "w-[40%]"
                  }`}
                >
                  John Wayne
                  <span
                    className={`${
                      screen === "mobile" ? "block mt-1" : "hidden"
                    } font-roboto text-[14px] font-normal leading-[19px] text-[#6D778E]`}
                  >
                    Berlin
                  </span>
                </td>
                <td
                  className={`font-roboto text-[16px] font-normal leading-[19px] text-[#3C3E41] w-[45%] ${
                ...
                <td
                  className={`font-roboto text-[28px] font-normal leading-[28px] text-[#D4D4D4] w-[5%] ${
                    screen === "mobile" ? "hidden" : ""
                  }`}
                >
                  &gt;
              ...
              <tr
                className={`h-[64px] w-[100%] ${
                  screen === "mobile" ? "" : "border-y border-gray-300"
                }`}
              >
                <td
                  className={`text-right pr-4 font-roboto text-[24px] font-normal leading-[28px]  w-[10%]  ${
          ...
          <p
            className={`mt-[40px] font-roboto  font-normal leading-[24px]  text-[#3C3E41] ${
              screen === "mobile"
                ? "text-left text-[16px]"
