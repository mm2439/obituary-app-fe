...
const OpeningDate = () => {
  return (
    <div className="w-full bg-[#E0E9F3]">
      <div className="w-full bg-[#BCD7F455] overflow-hidden flex justify-center items-center">
        {/*Main contianer*/}
        <div className="relative flex justify-center  tablet:items-center desktop:items-center flex-row w-full overflow-hidden dekstop:h-[328px] tablet:h-[284px] mobile:h-[394px]">
          <img
            src="/ozadje2.avif"
            alt="Flower_img"
            className="h-[328px] w-full object-cover hidden desktop:flex"
          />
