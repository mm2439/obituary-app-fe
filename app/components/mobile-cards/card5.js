...
const Card5 = () => {
  return (
    <div
      className="w-[360px] bg-[#FFFFFF] h-[720px] h-[50px] shadow-md overflow-hidden text-white"
    ...
    >
      ...
      <div className="text-container py-1 mt-[77px] h-[200px]">
        ...
        <div className="name-year-container text-[#935559] mt-[22px]">
          <h1 className="text-center text-[18px] h-[18px] font-normal">V spomin</h1>
          <h2  className="font-greatVibes text-[34px] h-[34px] font-normal text-center align-middle mt-[15px]" style={{ color: '#935559' }}>Mario Danilo Primo</h2>
