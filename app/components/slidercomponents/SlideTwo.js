...
const SlideTwo = () => {
  ...
  if (breakpoint === "desktop") {
    return (
     <div className="bg-[#F8EDE3] text-[#22281C] w-[1280px] h-auto">
        <div className="flex justify-around p-[179px]">
            <div className="image-container w-[560px]">
                <h2 className="text-[40px] mt-[16px]">Spominska stran <span className="text-[#de222e]">s skrbnikom</span></h2>
               ...
               <div className="inner-div mt-[80px]">
                ...
                <p>Prehitro nam uidejo, čarobni trenutki se pozabijo, slike zbledijo. Povežimo spomine na naše najdražje v celoto v digitalni obliki in jih ohranimo za vedno. </p>
               </div> 
               <div className="btn-container">

               <button class="px-[25px] py-[12px] mt-[47px]" style={{
            ...
            <div className="text-container">
                <img src="/mobile-cards/slider-mobile.png" alt="iPad Landscape" />
            </div>
        </div>
      </div>
    );
