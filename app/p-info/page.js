  ...
  return (
    <div className="bg-[#ECF0F3] min-h-[100vh] text-[#3C3E41]">
      ...
      <div className="flex flex-col items-center mobile:pt-[189px] pt-[200px] w-full px-4 max-w-[720px] mx-auto">
          ...
          <section className="mt-10 text-[16px] space-y-6 leading-[1.6] mobile:w-[360px] w-[704px]">
            <hr className="h-[1px] bg-[#D4D4D4] w-full mobile:block hidden"/>
            <div>
              <h3 className="font-medium mb-1 ">Kaj dobim?</h3>
            ...
            <hr className="h-[1px] bg-[#D4D4D4] w-full mobile:block hidden"/>
            <div>
              <h3 className="font-medium mb-1 ">Kakšne digitalne produkte?</h3>
              <p className="font-light text-[16px]">
            ...
            <hr className="h-[1px] bg-[#D4D4D4] w-full mobile:block hidden"/>
            <div>
              <h3 className="font-medium mb-1 ">Pa je res brezplačno?</h3>
              <p className="font-light text-[16px]">
            ...
            <hr className="h-[1px] bg-[#D4D4D4] w-full mobile:block hidden"/>
            <div>
              <h3 className="font-medium mb-1 ">Prezamudno bi bilo redno vnašati osmrtnice. Nismo vešči računalnika.</h3>
              <p className="font-light text-[16px]">
            ...
            <hr className="h-[1px] bg-[#D4D4D4] w-full mobile:block hidden"/>
            <div>
              <h3 className="font-medium mb-1 ">Kaj naj storim zdaj, kako naj začnem?</h3>
              <p className="font-light text-[16px]">
