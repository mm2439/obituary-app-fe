...
export default function Obituaries() {
  ...
  const [totalWithFunerals, setTotalWithFunerals] = useState(0);
  const [totalCompleteObits, setTotalCompleteObits] = useState(0);
            ...
            <table className="w-full border-separate border-spacing-[0] mobileUserAcc:w-[720px]">
              <thead>
                <tr className="text-[14px] tabletUserAcc:text-[14px] mobileUserAcc:text-[14px] text-[#3C3E41] font-variation-customOpt16 font-normal leading-[16px] uppercase">
                  <th className="w-[100px] tabletUserAcc:w-[150px] mobileUserAcc:w-[150px] pt-[8px]">
                    Mesec
                  </th>
                  <th className="w-[110px] shrink-0 pb-[7px] tabletUserAcc:text-[#530CC6] mobileUserAcc:text-[#530CC6]">
                    skupno osmrtnic
                  </th>
                  <th className="w-[90px] shrink-0 pb-[7px] tabletUserAcc:hidden mobileUserAcc:hidden">
                    s <br />
                    sliko
                  </th>
                  <th className="w-[110px] shrink-0 pb-[7px] tabletUserAcc:hidden mobileUserAcc:hidden">
                    s <br />
                    pogrebom
                  </th>
                  ...
                  <th className="w-[90px] pt-[8px]">OBOJE v %</th>
                  <th className="pb-[60px]"></th>
                  <th className="w-[130px] tabletUserAcc:w-[25%] mobileUserAcc:w-[25%] text-center pt-[8px] tabletUserAcc:text-[#530CC6] mobileUserAcc:text-[#530CC6]">
                    skrbnikov
                  </th>
              ...
              <tbody>
                ...
                <tr className="bg-white/40">
                  ...
                  <td className="py-[22px] px-4 text-[16px] leading-[19px] text-[#3C3E41] border-t border-b border-[#000000] text-center hidden tabletUserAcc:block mobileUserAcc:block">
                    <div className="flex items-center justify-center gap-[6px] text-[16px] text-[#6D778E]">
                      <span> {totalWithPhotos}</span>
                      <span className="text-[#D4D4D4]">I</span>
                      <span> {totalWithFunerals}</span>
                    </div>
                  </td>
                  <td className="p-4 text-[20px] leading-[19px] text-[#ACAAAA] border-t font-bold border-b border-[#000000] text-center">
                    {getObjavePercentage(totalCompleteObits, totalObits)}
                  </td>
                  <td className="border-t border-b border-[#000000]"></td>
