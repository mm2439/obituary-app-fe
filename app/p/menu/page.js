  ...
  {/* HEADER */}
    <UserCompanyHeaderNew
      ...
      isKeeper={showAlternateContent}
        ...
        />
        <div className="flex flex-col gap-4 min-h-screen min-w-full relative items-center justify-center py-[50px] tabletUserAcc:mt-[40px]">
          ...
          <div className="relative z-10 desktopUserAcc:pt-16 tabletUserAcc:pt-0">
            ...
            <div className="flex flex-row justify-center gap-x-[30px] left-[0px] right-[0px]">
              <div className="w-[322px] flex flex-col h-full mobileUserAcc:hidden">
                ...
                <Link href={absolutePath + "/nase_osmrtnice"} className="mt-[8px]">
                    <ButtonWhiteBG
              ...
              <div className="w-[314px] flex flex-col">
                ...
                <Link href="/user/funeral/notifications" className="bg-white rounded-lg py-4 px-6 flex items-center gap-4 justify-between shadow-[5px_5px_10px_rgba(194,194,194,0.5)] mt-[2px] mobileUserAcc:mt-[5px] relative overflow-hidden min-h-[55px]">
                  ...
                  <div className="flex items-center gap-5 absolute top-[2px] left-[2px] w-[calc(100%-55px)] h-[51px] bg-white rounded-s-md px-3">
                    ...
                    <h2 className="text-[16px] text-[#6D778E]">DODAJ OSMRTNICO</h2>
                  </div>
                </Link>
                <Link href="/user/funeral/notifications" className="bg-white rounded-lg py-4 px-6 flex items-center gap-4 justify-between shadow-[5px_5px_10px_rgba(194,194,194,0.5)] mt-[9px] mobileUserAcc:mt-[15px] relative overflow-hidden min-h-[55px]">
                  ...
                  <div className="flex items-center gap-5 absolute top-[2px] left-[2px] w-[calc(100%-55px)] h-[51px] bg-white rounded-s-md px-3">
                    <img src="/user/plus.png" alt="predloge" className="w-6 h-6 object-contain" />
                    <h2 className="text-[16px] text-[#6D778E]">PODARI SKRBNIKA</h2>
                  </div>
                </Link>
