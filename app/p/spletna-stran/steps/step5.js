  ...
  return (
    <>
        ...
        <div className="space-y-[20px]">
          ...
          <div className="space-y-[8px]">
            {sliderBlocks.map((block) => (
              <SliderBlock key={block.id} index={block.id} title={`Vprašanje ${block.id}`} />
            ))}
            <div className="flex items-center justify-end pt-[8px] pb-[16px]">
              <div className="inline-flex items-center gap-[8px] cursor-pointer" onClick={addSliderBlock}>
                ...
                <span className="text-[14px] text-[#3C3E41] font-normal leading-[100%]">DODAJ ŠE ENO VPRAŠANJE</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full">
        <img src="/funeral/6.png" alt="Spletna stran" className="w-full h-full object-contain" />
      </div>
    </>
  )
}
