...
import ButtonWhiteBG from "@/app/components/appcomponents/buttonwhitebg";
      ...
      isKeeper={showAlternateContent}
        ...
        <div className="flex flex-col gap-4 min-h-screen min-w-full relative items-center justify-center py-[50px]">
          ...
          <div className="relative z-10">
            <div className="w-full tabletUserAcc:max-w-[620px] desktopUserAcc:w-[620px] mobileUserAcc:max-w-[310px]">
              <div
                className="text-[#0A85C2] text-[26px] leading-[38px] font-[500px] mobileUserAcc:mt-[56px] mb-3"
                style={{
            ...
            <div className="flex flex-row justify-center gap-x-[30px] left-[0px] right-[0px]">
              ...
              <div className="w-[314px] flex flex-col">
                ...
                <div className="w-[314] h-[58px] mt-[10px] py-[2px] px-[2px] rounded-[10px] shadow-custom-light-dark-box-image bg-transparent opacity-0 invisible"></div>
                {/* {/ 21/10 changeeeee /} */}
                <div
                  onClick={() => {
                    setIsButtonHide(!isButtonHide);
                ...
                <Link href="/user/funeral/notifications" className="bg-white rounded-lg py-4 px-6 flex items-center gap-4 justify-between shadow-[5px_5px_10px_rgba(194,194,194,0.5)] mb-2 relative overflow-hidden min-h-[60px]">
